...
## [1.7.5] - 2023-12-09
### Fixed
- Fix configuration cache warnings. ([#167](https://github.com/equodev/equo-ide/issues/167))
...
## [1.7.2] - 2023-08-01
### Added
- `useMavenCentral(false)` to force pure-P2 resolution. ([#164](https://github.com/equodev/equo-ide/pull/164))
### Changed
